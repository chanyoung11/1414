...
with sync_playwright() as p:
    ...
    pl.wait_for_selector('#gtTeam'); pl.fill('#gtTeam','히어로팀'); pl.click('[data-act="team-create"]'); pl.wait_for_selector('.shell[data-page]')
    ...
    pm.wait_for_selector('#jnName'); pm.click('#gtSess .q:has-text("드럼")'); pm.click('[data-act="team-join"]'); pm.wait_for_selector('.shell[data-page]')
